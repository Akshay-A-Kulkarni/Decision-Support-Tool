...
- is_open (boolean; optional): Whether Toast is currently open.
...
toast on click
- n_dismiss (number; optional): An integer that represents the number of times that the dismiss button has
been clicked on.
- n_dismiss_timestamp (number; optional): Use of *_timestamp props has been deprecated in Dash in favour of dash.callback_context.
...
"dark"."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, header_style=Component.UNDEFINED, headerClassName=Component.UNDEFINED, body_style=Component.UNDEFINED, bodyClassName=Component.UNDEFINED, tag=Component.UNDEFINED, is_open=Component.UNDEFINED, key=Component.UNDEFINED, fade=Component.UNDEFINED, header=Component.UNDEFINED, dismissable=Component.UNDEFINED, n_dismiss=Component.UNDEFINED, n_dismiss_timestamp=Component.UNDEFINED, icon=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'header_style', 'headerClassName', 'body_style', 'bodyClassName', 'tag', 'is_open', 'key', 'fade', 'header', 'dismissable', 'n_dismiss', 'n_dismiss_timestamp', 'icon']
        self._type = 'Toast'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'header_style', 'headerClassName', 'body_style', 'bodyClassName', 'tag', 'is_open', 'key', 'fade', 'header', 'dismissable', 'n_dismiss', 'n_dismiss_timestamp', 'icon']
